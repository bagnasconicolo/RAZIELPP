...
QT_MOC_LITERAL(4, 34, 5) // "frame"
    ...
    "CaptureThread\0frameReady\0\0cv::Mat\0"
    "frame"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CaptureThread::*)(const cv::Mat & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::frameReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureThread::frameReady(const cv::Mat & _t1)
{
